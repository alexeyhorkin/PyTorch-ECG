...
def get_dataset(args, train_transform, test_transform):
    ...
    train_ecg_dataset = ECG_dataset(args.path_to_DataFile, args.cycle_length, 't',  is_train=True, transform=train_transform)
    test_ecg_dataset =  ECG_dataset(args.path_to_DataFile, args.cycle_length, 't',  is_train=False, transform=test_transform)
